...
public class LoginActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding.login.setHint(Constants.LOGIN);
        binding.forgotPassword.setText(Constants.FORGOT_PASS);
        binding.alreadyLoginText.setText(Constants.REGISTER_FLOW);
        ...
        binding.alreadyLoginText.setOnClickListener(new View.OnClickListener() {
            @Override
        ...
        binding.forgotPassword.setOnClickListener(view -> startActivity(new Intent(activity, ForgotPasswordActivity.class)));
    }

    //TODO :DO LOGIN USING THIS METHOD
    private void login() {
        Utils.hideKB(activity, binding.login);
            ...
            public void onSuccess(Response<ResponseBody> body) {
                ...
                try {
                    ...
                    if (pojo.status == 0) {
                        ...
                        storeUserData.setString(Constants.storeId, pojo.responsedata.manager_id);
